import {
  ...
  const projects = [
    {
      ...
      description:
        "...",
      image:
        "https://www.shutterstock.com/image-vector/hand-doctor-robot-finger-cyborg-600nw-2353082531.jpg",
      tags: [
        "Python",
        "AWS",
        "TensorFlow",
      ...
      github: "https://github.com/ibrahimw1/ai-doctor",
      webapp: "",
    },
    {
      id: 0,
      ...
      webapp: "https://potion-ai.vercel.app/",
      member: [
    ...
    },
    {
      ...
      category: "java",
      github: "https://github.com/ibrahimw1/airline-app",
      webapp: "",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "C++",
          image: "https://www.vikingsoftware.com/wp-content/uploads/2024/02/C-2.png",
        },
        {
          name: "Java",
          image:
      ...
      skills: [
        {
          name: "AWS",
          image:
            "https://media.licdn.com/dms/image/D4D12AQEmC2CSTK0unw/article-cover_image-shrink_600_2000/0/1691964348159?e=2147483647&v=beta&t=UA2DD5lAEDP28NHD9BRZIoriUAdwNxY8P465qku8lNY",
        },
        {
          name: "Azure",
          image:
        ...
        },
        {
          name: "OpenAI",
          image:
            "https://seeklogo.com/images/C/chatgpt-logo-4AE4C3B8A4-seeklogo.com.png",
        },
        {
          name: "Scikit-Learn",
          image:
        ...
        },
        {
          name: "MatPlotLib",
          image:
            "https://www.phidgets.com/education/wp-content/uploads/2021/04/Matplotlib_icon.png"
        },
        {
          name: "Beautiful Soup",
          image:
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "Eclipse",
          image:"https://cdn.freebiesupply.com/logos/large/2x/eclipse-11-logo-svg-vector.svg"
        },
        {
          name: "Xcode",
          image:
        ...
        },
        {
          name: "Linux",
          image:
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsiPmv7kx-pYFxI1-d8eFXdoiC_nKlk_ABJQ&s",
        },
      ],
    },
  ];
  ...
  export { services, technologies, experiences, projects, socials, skills };